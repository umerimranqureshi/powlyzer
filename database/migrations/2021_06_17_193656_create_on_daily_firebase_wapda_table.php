...
class CreateOnDailyFirebaseWapdaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('on_daily_firebase_wapda', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('on_daily_firebase_wapda');
    }
}
