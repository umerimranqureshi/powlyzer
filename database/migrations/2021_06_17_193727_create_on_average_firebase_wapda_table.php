...
class CreateOnAverageFirebaseWapdaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('on_average_firebase_wapda', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('on_average_firebase_wapda');
    }
}
