...
class CreateOnMinuteFirebaseWapdaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('on_minute_firebase_wapda', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('on_minute_firebase_wapda');
    }
}
