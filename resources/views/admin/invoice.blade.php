...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" >
	...
	<body>
		<div id="content-container"  style="height: 1000px;">
			<div id="_bg__ui_kit___dashboard___admin"  style="height: 1000px;" >
			...
			<div id="group_173" style="position: sticky;" >
				...
				<!-- <div id="group_9"  >
					...
					<div id="rectangle_1492_ek2"  style="background-color: rgb(193 210 255);" ></div>
					<div id="invoices" >
						Accounts
					</div>
</a>
...
<h2 class="heading-section" style="margin-left: 280px;">DUES & PAYMENT WITH VENDORS</h2>
...
$class1 = "<class=\"btn btn-success\"> " ;

    echo "<td> ".$class1."" . $user['paid'] . "  </td></t>";

$class = "<class=\"btn btn-success\"> " ;

 echo "  <td> ". $class . "". $user['due'] . "</td>";
  echo "</tr>";
