 ...
 *
 *	@desc 		
 *	@file 		ui_kit___dashboard___admin
 *	@date 		0
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" >
	<head>
		...
		<link rel="StyleSheet" href="<?php echo url('/'); ?>/admin/inbox.css" />
	...
	<body>
		<div id="content-container"  style="height: 1200px;">
			<div id="_bg__ui_kit___dashboard___admin"   style="height: 1200px;"></div>
			<div id="rectangle_1493"  ></div>

		

			<div id="group_173"  style="position: sticky;">
				...
				<div id="group_6"  >
					...
					<div id="rectangle_1492"  style="background-color: rgb(193 210 255);"  ></div>
					<div id="inbox" >
						Vendor
					</div>
				</a>
					<div id="mail"  >
					<div><img src="<?php echo url('/'); ?>/admin/skins/mask_group_1.jpg" style=" height:23px; "></div>
					</div>
				...
				<div id="group_9"  >
<a href="https://app.hubspot.com/live-messages/9378352/inbox/856246126#reply-editor" target="_blank">
			...
			<div id="group_14"  >
				<div >    	<p> <a href="/index"  style="background-color: #800080; border: 1px solid #800080;
         border-radius: 3px; padding: 10px 10px; text-decoration: none; color: #fff;
         font-family: inherit; font-size: inherit; font-weight: normal; line-height: inherit;
         text-align: left; text-shadow: none;">Logout</a> </p></div>
				<div id="arya_stark" >
...
<?php 
    ...
    // the table geek 
$query = "SELECT Username, email FROM users WHERE consumption != 0";       
...
{{--
    ...
    // query to fetch Username and Password from 
    // the table geek 
    $query = "SELECT Username, email FROM vendor"; 
...
<section class="ftco-section">
		<div class="container">
					...
					<h2 class="heading-section" style=" margin: auto; margin-top: -50px; width: 100%; border: 3px solid green; padding: 10px; text-align: center;">Vendors</h2>
  ...
  $(function() {
    $('.toggle-class').change(function() {
        ...
        $.ajax({
            ...
            dataType: "json", 
            url: '/changeStatus',
            data: {'status': status, 'vnedor_id': vendor_id},
...
<!-- <table>
	...
	<tbody>
		...
		<tr>
			...
			<td>{{$vendorDetail->cnic}}</td>
			<td>{{$vendorDetail->user_id}}</td>
			<td>{{$vendorDetail->created_at}}</td>
			<td>{{$vendorDetail->updated_at}}</td>
			
			<td><label class="switch">
				  <input type="checkbox">
				  <span class="slider round"></span>
				
				{{$vendorDetail->status}}</label></td>
		</tr>
		@endforeach
	</tbody>
</table> -->
...
if (!$db)
  ...
  $user_check_query = "SELECT * FROM vendor ";
...
while(  $user = mysqli_fetch_array($result))
  ...
  echo "<td>" . $user['email'] . "</td>";
    ...
    echo " <td ".$class."" . $user['status'] . "</td> </button>";
  echo "</tr>";
...
--}}
  ...
  <script src="<?php echo url('/'); ?>/admin/js/popper.js"></script>
  <script src="<?php echo url('/'); ?>/admin/js/bootstrap.min.js"></script>
  <script src="<?php echo url('/'); ?>/admin/js/main.js"></script>
			...
			<div id="group_9829"  >
				<div id="rectangle_16841_ek1"  ></div>

				<div id="arrow_pointing_to_right__3__ek1"  >
					<div id="path_1925_ek1"  ></div>
			...
			<div id="ellipse_373"  ></div>

			<div id="trending_up_ek1"  >
