...
<section class="ftco-section">
		<div class="container" style="width: 1050px;">
			...
			<h2 class="heading-section" style=" margin: auto; margin-top: -30px; width: 100%; border: 3px solid green; padding: 10px; text-align: center;">DEVICES</h2>
