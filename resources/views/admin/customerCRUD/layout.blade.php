...
<a href="https://app.hubspot.com/live-messages/9378352/inbox/856246126#reply-editor" target="_blank">
				...
				<div id="group_10"  >
					...
					<div id="rectangle_1492_ek5" style="background-color: rgb(193 210 255);"  > </div>
					<div id="customers" >
						Customers
					</div>
	</a>
...
<section class="ftco-section">
		<div class="container" style="width: 1050px;">
			...
			<h2 class="heading-section" style=" margin: auto; margin-top: -30px; width: 100%; border: 3px solid green; padding: 10px; text-align: center;">OUR CLIENTS</h2>
				
		<div class="">
			<div class="">
<!-- <h2 class="heading-section" style="margin-left: 400px;">OUR CLIENTS</h2> -->
...
while(  $user = mysqli_fetch_array($result))
  ...
  echo "<td>" . $user['address'] . "</td>";
   ...
   echo "<td>" . $user['consumption'] . "</td>";

    echo "<td>" . $user['production'] . "</td>";
	if($user['status'] == 1) 
		{
