	...
	<body>
		<div id="content-container"style="height: 1450px;" >
			...
			<div id="group_173"   style="position: sticky; height: 600px;" >
				...
				<div id="group_10" style="background-color: rgb(193 210 255);" >
...
<h2 class="heading-section" style="margin-left: 40%; width: 1000px;">OUR CUSTOMERS</h2>
...
<!-- <div class="container">
 ...
 -->
   									...
   									<a id="newCustomer" class="btn btn-success" style="color: white;"> Create New Device</a>
						       



						                <div id="addCustomer" style="padding: 15px; border-radius: 5px; background-color: #f2f2f2; padding: 20px;" >
...
<!-- vendor/store/device -->
										  ...
										  @csrf
										    ...
										    <label for="Device">Device</label>
										      ...
										      <input type="text" id="address" name="address" placeholder="Device Installed at..">
										    ...
										    <input id="newCustomer" type="submit" value="Submit">
						   ...
						   <div id="ShowCustomer" style="border-radius: 5px; background-color: #f2f2f2; padding: 20px; height: min-content;">
						    ...
						    <table class="table table-bordered">
						        ...
						        <tr>
									...
									<td>{{$client->id}}</td>
									<td>{{$client->status}}</td>
									<td>"Discription from client table"</td>
						            <td>
						                <form action="" method="POST">
						                ...
						                @method('DELETE')
						                    ...
						                    <button  id="show" class="btn btn-info"  style="color: white;"    >Show </button>
...
$(document).ready(function(){
  $("#newCustomer").click(function(){
    $("#ShowCustomer").toggle(600);
    $("#addCustomer").toggle(600);
...
<!-- <script>
function myFunction() {
  var x = document.getElementById("editCustomer");
...
</html><img src="<?php echo url('/'); ?>/vendor/images/footer.PNG">