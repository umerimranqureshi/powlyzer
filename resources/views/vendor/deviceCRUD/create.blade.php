...
<form action="/vendor/devices/store" method="POST" style="margin-top: 50px;">
    @csrf
     <div class="row">
                ...
                <input type="hidden" name="installed" value="Address" class="form-control" placeholder="Address">
