...
@section('content')
  <h2  style="background-color: white;">Edit Device</h2>
    ...
    <form action="/vendor/devices/update/{{$id}}" method="POST"  style="margin-top: 50px;">
        @csrf
        @method('POST')
                    ...
                    <input type="hidden" name="installed" value="{{ $installed }}" class="form-control" placeholder="Address">
