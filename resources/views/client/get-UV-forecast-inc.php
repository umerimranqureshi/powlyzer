...
// -------------Settings ---------------------------------
  ...
  $myLat = '24.8607';    //North=positive, South=negative decimal degrees
  $myLong = '67.0011';  //East=positive, West=negative decimal degrees
  $ourTZ = "Asia/Karachi";  //NOTE: this *MUST* be set correctly to
